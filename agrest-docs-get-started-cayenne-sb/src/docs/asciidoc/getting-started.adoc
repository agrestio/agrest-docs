...
supports Java versions 11 and higher. The full code of the tutorial is available
https://github.com/agrestio/agrest-docs/tree/5.x/agrest-docs-get-started-cayenne-sb[on Github].
