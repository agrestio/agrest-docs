...
Jersey (until at least 3.1) doesn't run standalone and will require some kind of Java "server" (Jetty,
Spring Boot, Bootique, etc.). Some examples of server integration are provided in the links below, and we will instead
focus on Agrest usage for the rest of this document:
