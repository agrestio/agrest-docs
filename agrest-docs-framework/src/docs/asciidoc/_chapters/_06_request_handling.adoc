...
one individually in the following chapters. Here we'll look at general principles of request handling. Below is a
typical JAX-RS endpoint implemented with Agrest:
